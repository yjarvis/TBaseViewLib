 ...
 *
 */
public class ShowImageActivity extends TFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imgList = (ArrayList<ImageItem>) intent.getSerializableExtra(Constrans.FLAG_IMAGE_SHOW);
	...
	private class ViewPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			return new ShowImageFragment().newInstance(imgList.get(position).getImagePath());
		}

package com.jarvis.tbaseviewlib.view.pullableview;
    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateTextView.setText(R.string.xlistview_header_hint_succeed);
            ...
            default:
                // 刷新失败
                refreshStateImageView.setVisibility(View.VISIBLE);
                refreshStateTextView.setText(R.string.xlistview_header_hint_fail);
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateTextView.setText(R.string.xlistview_footer_hint_succeed);
            ...
            default:
                // 加载失败
                loadStateImageView.setVisibility(View.VISIBLE);
                loadStateTextView.setText(R.string.xlistview_footer_hint_fail);
...
//		}.sendEmptyMessageDelayed(0, 1000);
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            case INIT:
                ...
                refreshStateTextView.setText(R.string.xlistview_header_hint_normal);
                pullView.clearAnimation();
                pullView.setVisibility(View.VISIBLE);
                // 上拉布局初始状态
                loadStateImageView.setVisibility(View.GONE);
                loadStateTextView.setText(R.string.xlistview_footer_hint_normal);
                pullUpView.clearAnimation();
                pullUpView.setVisibility(View.VISIBLE);
                break;
            case RELEASE_TO_REFRESH:
                // 释放刷新状态
                refreshStateTextView.setText(R.string.xlistview_header_hint_ready);
            ...
            case REFRESHING:
                ...
                refreshStateTextView.setText(R.string.xlistview_header_hint_loading);
                break;
            case RELEASE_TO_LOAD:
                // 释放加载状态
                loadStateTextView.setText(R.string.xlistview_footer_hint_ready);
            ...
            case LOADING:
                ...
                loadStateTextView.setText(R.string.xlistview_footer_hint_loading);
                break;
            case DONE:
                // 刷新或加载完毕，啥都不做
                break;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                //--------------------------------------------防止横向滑动冲突----------------------------------------------------------------------------
                if (mDisableWhenHorizontalMove && !mPreventForHorizontal && Math.abs(ev.getX() - lastX) > 20 && Math.abs(ev.getX() - lastX) > Math.abs((ev.getY() - lastY) / mResistance)) {
                    if ((ev.getY() - lastY) / mResistance <= 10) {
     ...
     * @param enableLoad
     */
    public void setPullLoadMore(boolean enableLoad) {
        enableLoadMore = enableLoad;
    }
     ...
     * @param enableRefresh
     */
    public void setPullRefresh(boolean enableRefresh) {
        this.enableRefresh = enableRefresh;
    }

    /**
     * 是否解决横向滑动的冲突
     * @param mDisableWhenHorizontalMove
     */
    public void setDisableWhenHorizontalMove(boolean mDisableWhenHorizontalMove) {
        this.mDisableWhenHorizontalMove = mDisableWhenHorizontalMove;
    }
}